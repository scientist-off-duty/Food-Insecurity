...
#MANOVAs for FI Set
#Change all FI code to include $ instead of . to replace variables in dataset----
...
final <- manova(RR_vars ~ AK_insight_plan_control*Radimer_cornell_food_insecure, data = Full_Set)
summary(final) 

final2 <- manova(FI.RR_vars ~ AK_insight_plan_control*Radimer_cornell_food_insecure, data = FI)
summary(final2) 
