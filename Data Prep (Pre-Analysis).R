...
#STROOP - Stroop effect, which is calculated by subtracting the color–word score 
#from the color score and is a measure of interference control. 

#A smaller congruency effect is thought to reflect stronger inhibition, because strong 
#inhibition of the irrelevant stimulus feature or the incorrect response tendency 
#should reduce the performance cost arising from the conflict in incongruent trials.
...
Full_Set$STROOP_total_rts_that_fit_criteria_average  <- scale(Full_Set$STROOP_total_rts_that_fit_criteria_average)
Full_Set$STROOP_congruent_rts_that_fit_critera_average - scale(Full_Set$STROOP_congruent_rts_that_fit_critera_average)
Full_Set$STROOP_incongruent_rts_that_fit_critera_average  - scale(Full_Set$STROOP_incongruent_rts_that_fit_critera_average)
Full_Set$STROOP_speed_interference  - scale(Full_Set$STROOP_speed_interference)
Full_Set$STROOP_congruent_trials_all_count  - scale(Full_Set$STROOP_congruent_trials_all_count)
Full_Set$STROOP_incongruent_trials_all_count  - scale(Full_Set$STROOP_incongruent_trials_all_count)
Full_Set$STROOP_congruent_trials_that_fit_criteria_count  - scale(Full_Set$STROOP_congruent_trials_that_fit_criteria_count)
Full_Set$STROOP_incongruent_trials_that_fit_criteria_count  - scale(Full_Set$STROOP_incongruent_trials_that_fit_criteria_count)
Full_Set$STROOP_total_num_trials - scale(Full_Set$STROOP_total_num_trials)

#dealing with high variance variables in FI -> scaled to standard deviation ----
FI$BART_points <- scale(FI$BART_points)
FI$STROOP_total_rts_that_fit_criteria_average  <- scale(FI$STROOP_total_rts_that_fit_criteria_average)
FI$STROOP_congruent_rts_that_fit_critera_average - scale(FI$STROOP_congruent_rts_that_fit_critera_average)
FI$STROOP_incongruent_rts_that_fit_critera_average  - scale(FI$STROOP_incongruent_rts_that_fit_critera_average)
FI$STROOP_speed_interference  - scale(FI$STROOP_speed_interference)
FI$STROOP_congruent_trials_all_count  - scale(FI$STROOP_congruent_trials_all_count)
FI$STROOP_incongruent_trials_all_count  - scale(FI$STROOP_incongruent_trials_all_count)
FI$STROOP_congruent_trials_that_fit_criteria_count  - scale(FI$STROOP_congruent_trials_that_fit_criteria_count)
FI$STROOP_incongruent_trials_that_fit_criteria_count  - scale(FI$STROOP_incongruent_trials_that_fit_criteria_count)
FI$STROOP_total_num_trials - scale(FI$STROOP_total_num_trials)
