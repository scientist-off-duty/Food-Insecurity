...
Race <- as.factor(Full_Set$Demographics_Race)
levels(Race) <- c("['Mixed Race']",             
                  "['Mixed Race']",
                  "['Mixed Race']",         
                  "['Mixed Race']",                                          
...
Race.FI <- as.factor(FI$Demographics_Race)
levels(Race.FI) <- c("['Mixed Race']",
                     "['American Indian or Alaskan Native']",                                          
                     "['Pacific Islander']",                                                                                 
                     "['Asian']",                                                                                                     
                     "['Black']",                                                                                            
...
Race.FI2 <- as.factor(FI$Demographics_Race)  
levels(Race.FI2) <- c("['Mixed Race']", 
                      "['Mixed Race']",                                           
                      "['Mixed Race']",                                                                                 
                      "['Asian']",                                                                                                     
                      "['Mixed Race']",                                                                                            
...
Full_Set %>%
  ggplot(aes(x=Race, y=FIS_food_insecurity_status)) +
